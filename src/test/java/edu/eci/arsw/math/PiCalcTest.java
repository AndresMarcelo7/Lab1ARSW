...
public class PiCalcTest {
    ...
    public void piGenTest() throws Exception {
        ...
        for (int start = 0; start < expected.length; start++) {
            for (int count = 5; count < expected.length - start; count++) {
    ...
    public void piGenTest3() throws Exception {
        ...
        for (int start = 0; start < expected.length; start++) {
            for (int count = 20; count < expected.length - start; count++) {
    ...
    @Test
    public void piGenTest4() throws Exception {
        ...
        for (int start = 0; start < expected.length; start++) {
            for (int count = 30; count < expected.length - start; count++) {
                byte[] digits = PiDigits.getDigits(start, count, 5);
                assertEquals(count, digits.length);
    ...
    @Test
    public void piGenTest5() throws Exception {
        ...
        for (int start = 0; start < expected.length; start++) {
            for (int count = 79; count < expected.length - start; count++) {
                byte[] digits = PiDigits.getDigits(start, count, 8);
                assertEquals(count, digits.length);
    ...
    @Test
    public void piGenTest6() throws Exception {
        ...
        for (int start = 0; start < expected.length; start++) {
            for (int count = 70; count < expected.length - start; count++) {
    ...
    @Test
    public void piGenTest7() throws Exception {
        ...
        for (int start = 0; start < expected.length; start++) {
            for (int count = 69; count < expected.length - start; count++) {
                byte[] digits = PiDigits.getDigits(start, count, 42);
                assertEquals(count, digits.length);
    ...
    @Test
    public void piGenTest8() throws Exception {
        ...
        for (int start = 0; start < expected.length; start++) {
            for (int count = 17; count < expected.length - start; count++) {
    ...
    @Test
    public void piGenTest9() throws Exception {
    ...
    @Test
    public void piGenTest10() throws Exception {
        ...
        for (int start = 0; start < expected.length; start++) {
            for (int count = 79; count < expected.length - start; count++) {
                byte[] digits = PiDigits.getDigits(start, count, 78);
                assertEquals(count, digits.length);
